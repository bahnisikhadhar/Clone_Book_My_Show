...
const popularMoviesUrl =
  Base_Url + "movie/popular?" + Api_key + "&language=en-US&page=3";
const topRatedMoviesUrl =
  Base_Url + "movie/top_rated?" + Api_key + "&language=en-US&page=2";
const latestMoviesUrl =
  Base_Url + "movie/now_playing?" + Api_key + "&language=en-US&page=2";

const trendingMovieNamesUrl =
  Base_Url +
  "discover/movie?" +
  Api_key +
  "&sort_by=popularity.desc&page=1&primary_release_year=2022&with_original_language=ml|bn|ta";
const recommendedMoviesUrl =
  Base_Url +
  "discover/movie?" +
  Api_key +
  "&sort_by=popularity.desc&page=1&primary_release_year=2022&with_original_language=hi";
const likedIndianMovies =
  Base_Url +
  "discover/movie?" +
  Api_key +
  "&sort_by=popularity.desc&page=2&primary_release_year=2022&with_origin_country=IN";
const popularMoviesUrl2 =
  Base_Url +
  "discover/movie?" +
  Api_key +
  "&sort_by=popularity.desc&page=1&primary_release_year=2021&with_original_language=ml|bn|ta";
...
function showLikedIndianMovies(movies) {
  ...
  movies.forEach((movie) => {
    ...
    indianEl.innerHTML = `
      ...
      poster_path
        ? img_url + poster_path
        : img_url + "/w896mqGi91LrTp2pUsc8a9QAbyL.jpg"
    }" alt="" /></a>
                 <div class="like_vote">
                  <p><i class="fa-solid fa-thumbs-up"></i> ${Number(
                    popularity / 10
